...
viz.plot_map(data, affine, anat=anat, anat_affine=anat_affine,
             slicer='z', threshold=3, cmap=viz.cm.cold_hot, black_bg=True)
plt.savefig('z_view.png')

viz.plot_map(data, affine, anat=anat, anat_affine=anat_affine,
             slicer='x', threshold=3, cmap=viz.cm.cold_hot, black_bg=True)
plt.savefig('x_view.png')

viz.plot_map(data, affine, anat=anat, anat_affine=anat_affine,
             slicer='y', threshold=3, cmap=viz.cm.cold_hot, black_bg=True)
